...
pin5 = Pin.create!(title: "Blue Mermaid", description: "Digital artwork of a blue mermaid", author_id: 1)
...
pin5.photo.attach(io: open('https://danterest-dev.s3-us-west-1.amazonaws.com/DTseed/blueMermaid.JPG'), filename:'blueMermaid.JPG')
